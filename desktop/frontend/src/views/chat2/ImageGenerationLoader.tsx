...
registerMessages({
  ...
  'imageGeneration.controls': { zh: '贪吃蛇：方向键、WASD 或滑动控制，再次点击退出', en: 'Snake: use arrow keys, WASD, or swipe to steer; click again to exit' },
...
export function ImageGenerationLoader() {
  ...
  const onPointerUp = (event: PointerEvent<HTMLButtonElement>): void => {
    ...
    // pointerup 后浏览器还会派发 click；滑动只负责转向，不能顺手把游戏退出。
