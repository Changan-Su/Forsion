...
// RightViews 的 subchats 视图把 /background 的行并进 live 时的形状:id=runId,没有 sessionId
const merged = (runId: string, title: string): SubChat => ({ id: runId, kind: 'discussion', title, runId, streaming: false, segs: [] })
