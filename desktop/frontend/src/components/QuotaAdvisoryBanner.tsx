...
registerMessages({
  ...
  'quota.banner.bg.period.daily': { zh: '后台智能体今日额度', en: "Background agents' daily quota" },
  'quota.banner.bg.period.weekly': { zh: '后台智能体本周额度', en: "Background agents' weekly quota" },
